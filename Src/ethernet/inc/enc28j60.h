...
#define ENCJ_SPI    SPI1

#define encjCS_RCC  RCC_AHB1Periph_GPIOA
#define encjCS_Pin  GPIO_Pin_4
#define encjCS_Port GPIOA

#define disableChip  GPIO_SetBits(encjCS_Port,encjCS_Pin); delay_us(2);
#define enableChip   GPIO_ResetBits(encjCS_Port,encjCS_Pin); delay_us(2);
...
void ENC28J60_SPI_Configuration(void);
